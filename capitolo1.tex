...
La necessità di rendere più autonoma possibile la comunicazione tra dispositivi e applicazioni, ha portato allo sviluppo di numerose tecniche e protocolli così detti di \textit{auto-configurazione}, che permettono un setup automatico dei dispositivi all'interno della rete locale, e quindi non necessitando di una configurazione \qts{manuale}. 
