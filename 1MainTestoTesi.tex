...
% e il numero di linee per pagina, nonchè di centrare il testo sia orizzontalmente che
% verticalmente.

% Non viene specificato se il testo debba essere formattato nella pagina: ciò
% vuol dire che il testo sarà messo su un unica colonna, come di default.

% Non è specificato come debbano essere stampate le pagine, questo vuol dire che
% si adotta l'opzione twoside di default per i book, cioè i numeri di pagina
% appaiono sulla sinistra per le pagine pari e sulla destra per le pagine dispari

% Non è specificata nessuna opzione di inizio di capitolo su pagina, questo vuol
% dire che si adotta lo stile di default per i book, cioè i capitoli iniziano nella
% pagina destra
...
% una nuova pagina. Per esempio è possibile passare da una colonna a 2 e poi
...
% opzione è utile per eseguire una compilazione veolce per verificare il posizionamento
% delle figure. 
...
% Permette di creare celle che spaziano su più righe
\usepackage{multirow}
